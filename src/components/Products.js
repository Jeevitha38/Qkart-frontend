...
const Products = () => {
    ...
    { 
        const newDebounceTimeout = debounceSearch(event, debounceTimeout); setDebounceTimeout(newDebounceTimeout); 
    }; 
    ...
    const addToCart = async ( 
        ...
        { 
            ...
            { 
                ...
                { enqueueSnackbar("Could not add to cart. Something went wrong.", { variant: "error", }); 
                } 
            } 
        };
        ...
        return ( <div> 
            ...
            placeholder="Search for items/categories" name="search" 
            value={searchText} 
            onChange={handleSearch} /> 
            </Header>
            <TextField className="search-mobile" 
            ...
            {username && 
            <Grid item sx={{backgroundColor:"#E9F5E1", display: username !== "" ? "block" : "none"}} 
            xs={12} md={3} > 
