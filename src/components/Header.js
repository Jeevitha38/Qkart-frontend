    ...
    <Box className="header">
      ...
      (<Button className="explore-button" startIcon={<ArrowBackIcon />} variant="text" onClick={(e) => {history.push("/");
        ...
        <Box>          {log ? (
            ...
            <Stack direction="row" spacing={2} alignItems="center">              <Button                className="explore-button"                variant="text"                onClick={(e) => {
                  history.push("/login");
                }}
              >                LOGIN
              </Button>              <Button                className="button"                variant="contained"                onClick={(e) => {
